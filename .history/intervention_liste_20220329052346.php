    ...
    <div class="container">
      <div class="row">
        ...
        <div id="liste">
          ...
          <?php
          $requete = mysqli_query($conn, "SELECT * FROM interventions ORDER BY inter_id DESC LIMIT 100 ") or die('Erreur SQL !' . $requete . '<br>' . mysqli_error());
          ...
          <table class="interv-list" width="80%" border="0" align="center">
            <thead>
              <tr>
                ...
                <th width="80">Etats</th>
                <th width="100">&nbsp;</th>
                <th width="40"><i class='fa fa-remove' style='color: red; font-size:20px; font-weight:700'></i> </th>
              </tr>
            </thead>
            <tbody>
              <tr>
                ...
                ?>
                  ...
                  echo "<td><i class='fa fa-remove' style='color: red; font-size:20px; font-weight:700'></i></td>";
                  ?>
