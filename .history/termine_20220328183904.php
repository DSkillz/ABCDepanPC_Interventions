    ...
    <div class="container">
      <div class="row">
        ...
        <p>
          ...
          <?php
          $requete = mysqli_query($conn, "SELECT * FROM interventions WHERE inter_status ='termine' ") or die('Erreur SQL !' . $requete . '<br>' . mysqli_error());
        ...
        <table c width="100%" border="0">
          ...
          <tr>
            <?php while ($donnees = mysqli_fetch_assoc($requete)) { ?>
              ...
              <form method="post" action="status_modif_termine.php" enctype="multipart/form-data">
