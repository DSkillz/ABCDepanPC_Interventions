          ...
          <tbody>
            <tr>
              <?php while ($donnees = mysqli_fetch_assoc($requete)) { ?>
                ...
                <form method="get" action="status_modif.php" enctype="multipart/form-data">
                  ...
                  ?>
                  <a href='intervention_modif.php?id=" . $donnees['inter_id'] . "'><button>Modifier Fiche</button></a></td>";
