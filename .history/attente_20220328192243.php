...
<?php
	$requete = mysqli_query($conn, "SELECT * FROM interventions WHERE inter_status ='sav' OR inter_status ='commande' OR inter_status ='electro'  OR inter_status = 'attente' ORDER BY inter ") or die('Erreur SQL !'.$requete.'<br>'.mysqli_error());    
