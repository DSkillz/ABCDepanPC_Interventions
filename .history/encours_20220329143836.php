...
<p>
  ...
  $totRequest = mysqli_query($conn, "SELECT COUNT(*) as NBtotal FROM interventions ") or die('Erreur SQL !' . $totRequest . '<br>' . mysqli_error());
  $dataT = mysqli_fetch_assoc($reqtotRequestuete);
  ...
  <center style="color:#FFF; ">
    &nbsp;&nbsp;
    <a href="intervention_liste.php" target="_self" style="color:#F90">Interventions<?php echo $data['NBtotal']; ?></a>
    &nbsp;&nbsp;
