...
$totRequest = mysqli_query($conn, "SELECT COUNT(*) as NBtotal FROM interventions ") or die('Erreur SQL !' . $requete . '<br>' . mysqli_error());
$dataTotal = mysqli_fetch_assoc($requete);
  ...
  &nbsp;&nbsp;
    <a href="afaire.php" target="_self" style="color:#F90">A faire <?php echo $data['NBtotal']; ?></a>  
  &nbsp;&nbsp;
