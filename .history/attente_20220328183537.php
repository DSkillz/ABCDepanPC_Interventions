...
<?php
	$requete = mysqli_query($conn, "SELECT * FROM interventions WHERE inter_status ='sav' OR inter_status ='commande' OR inter_status ='electro'  OR inter_status = 'attente' ") or die('Erreur SQL !'.$requete.'<br>'.mysqli_error());    
	
?>

<table cl width="100%" border="0" >
  <tr>
  	<td>&nbsp;</td>
    <td>Date</td>
  ...
  <form method="post" action="status_modif_attente.php" enctype="multipart/form-data">
  ...
  if ($donnees['inter_status'] == 'attente') { $typeStatue = 'En attente'; }
