    ...
    <div class="container">
      <div class="row">
        ...
        <div id="liste">
          ...
          <input type="search" placeholder="Search..." class="form-control search-input" data-table="interv-list" width="70%" />


          <table class="interv-list" width="70%" border="0" align="center">
            <tr>
              <td width="100">&nbsp;</td>
              <td width="40">N°</td>
