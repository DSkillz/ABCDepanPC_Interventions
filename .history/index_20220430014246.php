...
content = "" >
	<
	meta name = "author"
content = "Sergey Pozhilov (GetTemplate.com)" >
...
href = "assets/images/gt_favicon.png" >
...
main class = "container-fluid" >
	<
	div class = "row"
style = "position: relative;top: 32vh;" >
...
for = "form2Example1" > Identifiant < /label> <
	/div>
...
class = "form-control" / >
	<
	label class = "form-label"
for = "form2Example2" > Mot de passe < /label> <
	/div>
...
onclick = "SubmitFormData();" > Connexion < /button> <
	/form> <
	/main>
